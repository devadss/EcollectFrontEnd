...
export const themes = {
  ...
  light: {
    ...
    bgSecondary: '#ffffff',
    bgCard: '#ffffff',
    bgCardGlass: 'rgba(255, 255, 255, 0.96)',
    bgHover: '#f1f5f9',
    textPrimary: '#0f172a',
    ...
    cardShadow: '0 4px 20px -2px rgba(15, 23, 42, 0.08), 0 2px 6px -1px rgba(15, 23, 42, 0.04)',
    cardShadowHover: '0 12px 30px -4px rgba(15, 23, 42, 0.12), 0 0 20px -3px rgba(79, 70, 229, 0.15)',
    sidebarBg: '#ffffff',
    sidebarText: '#475569',
    sidebarActive: '#0f172a',
    sidebarHover: '#f1f5f9',
    sidebarActiveBg: 'linear-gradient(135deg, rgba(79, 70, 229, 0.12) 0%, rgba(99, 102, 241, 0.05) 100%)',
    accent: '#4f46e5',
  ...
  // 2B. Stripe Platinum Luxe Light (Apple Card / High-Contrast Silicon Valley Standard)
  lightPlatinum: {
    ...
    bgSecondary: '#ffffff',
    bgCard: '#ffffff',
    bgCardGlass: 'rgba(255, 255, 255, 0.98)',
    bgHover: '#e2e8f0',
    textPrimary: '#020617',
    ...
    cardShadow: '0 4px 20px -2px rgba(2, 6, 23, 0.09), 0 2px 6px -1px rgba(2, 6, 23, 0.04)',
    cardShadowHover: '0 14px 32px -4px rgba(2, 6, 23, 0.15), 0 0 22px -3px rgba(37, 99, 235, 0.2)',
    sidebarBg: '#ffffff',
    sidebarText: '#334155',
