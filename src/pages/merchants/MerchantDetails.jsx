              ...
              <div className="info-card">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span>{merchant.businessCategory || 'N/A'}</span>
                  </div>
                  <div className="info-item">
                    <label>Entity Type</label>
                    <span>{merchant.entityType || 'N/A'}</span>
                  </div>
                  <div className="info-item">
                    <label>Website</label>
                    <span>{merchant.websiteUrl ? <a href={merchant.websiteUrl} target="_blank" rel="noopener noreferrer">{merchant.websiteUrl}</a> : 'N/A'}</span>
                  </div>
                  <div className="info-item full-width">
                    <label>Registered Address</label>
                    <span>{merchant.registeredAddress || 'N/A'}</span>
                  </div>
                </div>
              </div>
