...
const Merchants = () => {
  ...
  return (
    <>
      ...
      {loading && <LoadingAnimation message="Loading Merchants" />}
      ...
      <DashboardLayout role="softwareadmin">
        <div className={`merchants-page ${loading ? 'content-blurred' : ''}`}>
          ...
          <div className="page-header">
            <div>
              <h1 className="page-title"><span className="gradient-text">Merchants</span></h1>
              <p className="page-subtitle">Manage all registered merchants</p>
            </div>
            <button className="btn-primary" onClick={() => navigate('/merchants/add')}>
              ➕ Add Merchant
            </button>
          </div>
          ...
          <div className="table-card">
            <div className="table-header">
              <div className="table-title">
                <span className="gradient-text">All Merchants</span>
                  ...
                  {filteredMerchants.length === 0 ? (
                    ...
                    filteredMerchants.map((m, index) => (
                      <tr key={m.id}>
                        ...
                        <td>{m.registeredEmail}</td>
                        <td>{m.registeredPhone}</td>
                        <td>
